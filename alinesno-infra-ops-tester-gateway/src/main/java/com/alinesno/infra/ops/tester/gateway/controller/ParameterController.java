...
@RestController
@Scope("prototype")
@RequestMapping("/api/infra/ops/tester/parameter")
public class ParameterController extends BaseController<ParameterEntity, IParameterService> {
    ...
    @Override
    public IParameterService getFeign() {
        return this.service;
    }
}