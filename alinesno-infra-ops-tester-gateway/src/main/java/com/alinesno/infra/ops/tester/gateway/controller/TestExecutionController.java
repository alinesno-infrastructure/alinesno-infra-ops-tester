...
@RestController
@Scope("prototype")
@RequestMapping("/api/infra/ops/tester/testExecution")
public class TestExecutionController extends BaseController<TestExecutionEntity, ITestExecutionService> {

    @Autowired
    private ITestExecutionService service;
    ...
    @Override
    public ITestExecutionService getFeign() {
        return this.service;
    }
}