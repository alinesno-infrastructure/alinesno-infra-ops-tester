...
@RestController
@Scope("prototype")
@RequestMapping("/api/infra/ops/tester/testReport")
public class TestReportController extends BaseController<TestReportEntity, ITestReportService> {

    @Autowired
    private ITestReportService service;
    ...
    @Override
    public ITestReportService getFeign() {
        return this.service;
    }
}